...
msrp_pipeline = Pipeline([
    ...
    ('categorical_encoder', OrdinalEncoder(encoding_method='ordered', variables=config.model_config.categorical_var)),

    #scaling our feature parameters
    ('scalar', MinMaxScaler()),

    #final estimator
    ('abr', abr(random_state= config.model_config.random_state
